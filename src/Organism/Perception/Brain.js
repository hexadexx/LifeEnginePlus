...
class Brain {
    constructor(owner){
        ...
        this.decisions[CellStates.plant.name] = Decision.chase;
        this.decisions[CellStates.meat.name] = Decision.chase;
    ...
    randomizeDecisions(randomize_all=false) {
        ...
        if (randomize_all) {
            ...
            this.decisions[CellStates.plant.name] = Decision.getRandom();
